                ...
                <div class="grid gap-10 mx-auto lg:grid-cols-2 lg:max-w-screen-lg">
                    <div class="grid sm:grid-cols-3">
                        ...
                        <div class="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
                            ...
                            <p class="mb-4 text-xl text-gray-50">Product Manager</p>
                            <p class="mb-4 text-sm tracking-wide text-gray-50">
                    ...
                    <div class="grid sm:grid-cols-3">
                        ...
                        <div class="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
                            ...
                            <p class="mb-4 text-xl text-gray-50">Design Team Lead</p>
                            <p class="mb-4 text-sm tracking-wide text-gray-50">
                    ...
                    <div class="grid sm:grid-cols-3">
                        ...
                        <div class="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
                            ...
                            <p class="mb-4 text-xl text-gray-50">Human Resources</p>
                            <p class="mb-4 text-sm tracking-wide text-gray-50">
                    ...
                    <div class="grid sm:grid-cols-3">
                        ...
                        <div class="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
                            ...
                            <p class="mb-4 text-xl text-gray-50">Good guy</p>
                            <p class="mb-4 text-sm tracking-wide text-gray-50">
